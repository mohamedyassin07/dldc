    ...
    public function setUp() {
        ...
        private function _getLabels() {
            ...
            return $this->oProp->bIsAdmin
                ? array(
                    'name'               => __( 'APF Demo 1', 'admin-page-framework-loader' ),
                    'menu_name'          => __( 'APF Demo 2', 'admin-page-framework-loader' ),
                    'all_items'          => __( 'Manage Sample Posts', 'admin-page-framework-loader' ),
                    'singular_name'      => __( 'APF Demo 3', 'admin-page-framework-loader' ),
