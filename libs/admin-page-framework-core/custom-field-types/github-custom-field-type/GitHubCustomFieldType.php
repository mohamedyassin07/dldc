...
class GitHubCustomFieldType extends AdminPageFramework_FieldType {
    ...
    protected function getField( $aField ) { 
        ...
        return 
            $aField['before_label']
            . "<div class='DLDC-input-label-container'>"        
                . $aField['before_input']
                . ( $aField['label'] && ! $aField['repeatable']
                    ? "<span class='DLDC-input-label-string' style='min-width:" . $this->getLengthSanitized( $aField['label_min_width'] ) . ";'>" . $aField['label'] . "</span>"
                    : "" 
                )
        ...
        private function _getButtonLabelByType( $sButtonType, $sUserName, $sValue ) {
            ...
            switch( $sButtonType ) {
                case 'follow': 
                    return sprintf( __( 'Follow @%1$s', 'DLDC' ), $sUserName );
                case 'watch':
                    return __( 'Watch', 'DLDC' );
                case 'star':
                    return __( 'Star', 'DLDC' );
                case 'fork':
                    return __( 'Fork', 'DLDC' );
                case 'issue':
                    return __( 'Issue', 'DLDC' );
                default:
                    return '';
            }                 
