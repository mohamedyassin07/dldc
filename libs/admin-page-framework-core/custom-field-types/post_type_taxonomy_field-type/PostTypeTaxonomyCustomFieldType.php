...
jQuery( document ).ready( function(){
    ...
    jQuery( '.DLDC-checkbox-container-posttype[data-select_all_button]' ).each( function( iIndex ){
    ...
    jQuery( '.DLDC-checkbox-container-posttype[data-select_none_button]' ).each( function( iIndex ){
    ...
    jQuery( document ).on( 'change', '.DLDC-field-post_type_taxonomy .DLDC-field-posttype input[type="checkbox"]', function() {
        ...
        var _oField              = jQuery( this ).closest( '.DLDC-field-post_type_taxonomy' );
    ...
    jQuery( '.DLDC-field-post_type_taxonomy .DLDC-field-posttype input[type="checkbox"]:not(:checked)' ).each( function(){
    ...
    jQuery().registerAdminPageFrameworkCallbacks( {
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            oCloned.find( '.DLDC-field-posttype input[type="checkbox"]' )
                .prop( 'checked', false )
                .trigger( 'change' );         
...
.DLDC-field-post_type_taxonomy .select_all_button_container, 
.DLDC-field-post_type_taxonomy .select_none_button_container
{
...
.DLDC-field-post_type_taxonomy .select-taxonomy-terms-checkbox-container {
            ...
            return "<div class='select-taxonomy-terms-checkbox-container'>"
                    . "<label class='select-taxonomy-terms'>"
                        ...
                        . "<input " . $this->getAttributes( $_aCheckboxAttributes ) . " />"
                            . __( 'Select taxonomy terms.', 'DLDC-loader' )
                    . "</label>"
                . "</div>";
