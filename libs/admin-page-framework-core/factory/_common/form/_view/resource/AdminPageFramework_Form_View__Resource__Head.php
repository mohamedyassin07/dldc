...
class AdminPageFramework_Form_View__Resource__Head extends AdminPageFramework_FrameworkUtility {
    ...
    public function _replyToInsertRequiredInternalScripts() {
        ...
        echo "<script type='text/javascript' class='DLDC-form-script-required-in-head'>" . '/* <![CDATA[ */ ' . $this->_getScripts_RequiredInHead() . ' /* ]]> */' . "</script>";
    }
    private function _getScripts_RequiredInHead() {
        return 'document.write( "<style class=\'DLDC-js-embedded-internal-style\'>' . str_replace('\\n', '', esc_js($this->_getInternalCSS())) . '</style>" );';
    }
    ...
    private function _getScriptElementConcealerCSSRules() {
        return ".DLDC-form-js-on {visibility: hidden;}.widget .DLDC-form-js-on { visibility: visible; }";
    }
    }
