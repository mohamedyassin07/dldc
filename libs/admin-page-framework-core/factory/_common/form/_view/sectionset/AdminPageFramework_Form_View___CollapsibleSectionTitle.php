...
class AdminPageFramework_Form_View___Section_Base extends AdminPageFramework_Form_Base {
    ...
    class AdminPageFramework_Form_View___SectionTitle extends AdminPageFramework_Form_View___Section_Base {
        ...
        private function _getCollapseButton($aCollapsible) {
            ...
            return $this->getAOrB('button' === $this->getElement($aCollapsible, 'type', 'box'), "<span class='DLDC-collapsible-button DLDC-collapsible-button-expand' title='{$_sExpand}'>&#9658;</span>" . "<span class='DLDC-collapsible-button DLDC-collapsible-button-collapse' title='{$_sCollapse}'>&#9660;</span>", '');
        }
    ...
    class AdminPageFramework_Form_View___CollapsibleSectionTitle extends AdminPageFramework_Form_View___SectionTitle {
        ...
        private function _getCollapsibleSectionTitleBlock(array $aCollapsible, $sContainer = 'sections', $iSectionIndex = null) {
            ...
            return $this->_getCollapsibleSectionsEnablerScript() . "<div " . $this->getAttributes(array('id' => $_sSectionTitleTagID, 'class' => $this->getClassAttribute('DLDC-section-title', $this->getAOrB('box' === $aCollapsible['type'], 'accordion-section-title', ''), 'DLDC-collapsible-title', $this->getAOrB('sections' === $aCollapsible['container'], 'DLDC-collapsible-sections-title', 'DLDC-collapsible-section-title'), $this->getAOrB($aCollapsible['is_collapsed'], 'collapsed', ''), 'DLDC-collapsible-type-' . $aCollapsible['type']),) + $this->getDataAttributeArray($aCollapsible)) . ">" . $_sSectionTitle . "</div>";
        }
