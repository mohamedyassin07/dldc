...
(function($) {
    $.fn.enableAdminPageFrameworkSortableSections = function( sSectionsContainerID ) {
        ...
        var _bIsTabbed      = _oTarget.hasClass( 'DLDC-section-tabs-contents' );
        var _bCollapsible   = 0 < _oTarget.children( '.DLDC-section.is_subsection_collapsible' ).length;

        var _oTarget        = _bIsTabbed
            ? _oTarget.find( 'ul.DLDC-section-tabs' )
            : _oTarget;
        ...
        var _aSortableOptions = { 
                items: _bIsTabbed
                    ? '> li:not( .disabled )'
                    : '> div:not( .disabled, .DLDC-collapsible-toggle-all-button-container )', 
                handle: _bCollapsible
                    ? '.DLDC-section-caption'
                    : false,
                ...
                // cancel: '.DLDC-section-description, .DLDC-section-title'
        ...
        if ( ! _bIsTabbed ) {
            ...
            _oSortable.on( 'sortstop', function() {
                ...
                jQuery( this ).find( 'caption > .DLDC-section-title:not(.DLDC-collapsible-sections-title,.DLDC-collapsible-section-title)' ).first().show();
                jQuery( this ).find( 'caption > .DLDC-section-title:not(.DLDC-collapsible-sections-title,.DLDC-collapsible-section-title)' ).not( ':first' ).hide();
...
JAVASCRIPTS;
            return "<script type='text/javascript' class='DLDC-section-sortable-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
        }
    }
