...
class AdminPageFramework_FieldType_radio extends AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".DLDC-field input[type='radio'] {margin-right: 0.5em;} .DLDC-field-radio .DLDC-input-label-container {padding-right: 1em;} .DLDC-field-radio .DLDC-input-container {display: inline;} .DLDC-field-radio .DLDC-input-label-string{display: inline; }";
    }
    ...
    jQuery().registerAdminPageFrameworkCallbacks( { 
        ...
        repeated_field: function( oCloned, aModel ) {            
            oCloned.find( 'input[type=radio]' )
                ...
                jQuery( this ).closest( '.DLDC-field' ).find( 'input[type=radio]' )
                    .prop( 'checked', false )
                    .attr( 'checked', false ); 
...
jQuery( document ).ready( function(){
    jQuery( 'input[type=radio][data-id=\"{$sInputID}\"]' ).on( 'change', function( e ) {
        ...
        // Uncheck the other radio buttons
        jQuery( this ).closest( '.DLDC-field' ).find( 'input[type=radio][data-id=\"{$sInputID}\"]' )
            .prop( 'checked', false )
            .attr( 'checked', false );
