...
jQuery( document ).ready( function() {
    jQuery( '.DLDC-field-import input[type=submit]' ).on( 'click', function( event ) {
        var _iFiles = jQuery( this ).closest( '.DLDC-field-import' ).find( 'input[type=file]' ).get( 0 ).files.length;
        if ( 0 === _iFiles ) {
...
JAVASCRIPT;
    ...
    protected function getStyles() {
        return ".DLDC-field-import input {margin-right: 0.5em;}.DLDC-field-import,.DLDC-field-import .DLDC-input-label-container {width: 100%;}.DLDC-field-import label,.form-table td fieldset.DLDC-fieldset .DLDC-field-import label { display: inline-block; width: auto;vertical-align: middle;}";
    }
